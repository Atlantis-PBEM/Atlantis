...
Alpine.store('resources', [
    { title: 'Stone', checked: false },
    { title: 'Wood', checked: false },
    { title: 'Yew', checked: false },
    { title: 'Mithril', checked: false },
])
...
function draw() {
    ...
    // demo code that shows how to access the resources store
    const resources = Alpine.store('resources')
    for (const resource of resources) {
        // resources must be accessed for Alpine to detect the dependency and call draw again
        console.log(resource.title, resource.checked)
    }
